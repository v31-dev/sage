...
from playhouse.signals import Model, post_delete, post_save, pre_save

from services.base import Base
from utils.db import CleanCharField, EncryptedTextField
...
class Database(Base):
    def __init__(self):
        ...
        db.create_tables(
            [Setting, Project, Application, Domain, Worker, Container, Deployment],
            safe=True,
        )
