        ...
        <FieldGroup>
          <Field>
            <p class="text-sm text-muted-foreground">
              Are you sure you want to delete this {{ props.title.toLowerCase() }}? This action
              cannot be undone.
            </p>
          </Field>
          <Field>
            <FieldError v-if="deleteDialogErrorMessage">{{ deleteDialogErrorMessage }} </FieldError>
          </Field>
        </FieldGroup>
      </FieldSet>
      <DialogFooter>
        <Button
          size="sm"
          variant="destructive"
          @click="onClickDeleteApplicationConfirm"
